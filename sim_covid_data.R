...
dist_age_male <- c(0.01616346,   # 0 - 39
                     0.04159445,   # 40 - 49
                     0.10130439,   # 50 - 59
                     0.16825686,   # 60 - 69
                     0.25217550,   # 70 - 79
...
dist_age_female <-   c(0.01688613,   # 0 - 39
                       0.04271329,   # 40 - 49
                       0.10131681,   # 50 - 59
                       0.16841872,   # 60 - 69
                       0.25289366,   # 70 - 79
...
set.seed(1234)
data_simulated <- sample_from(data_model, 10000)
saveRDS(data_simulated, file = "data/simulated_covid_france.rds")
